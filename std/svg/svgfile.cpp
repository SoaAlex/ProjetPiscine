...
void Svgfile::addText(double x, double y, std::string text,int agrandissement, std::string color)
{
    m_ostrm << "<text "
...
void Svgfile::addText(double x, double y, double val,int agrandissement, std::string color)
{
    std::ostringstream oss;
    oss << val;
    addText(x, y, oss.str(),agrandissement, color);
}
